"""taximo_25167 URL Configuration
...
admin.site.site_header = "Taximo"
admin.site.site_title = "Taximo Admin Portal"
admin.site.index_title = "Taximo Admin"

# swagger
api_info = openapi.Info(
    title="Taximo API",
    default_version="v1",
    description="API documentation for Taximo App",
)
